...
/// <summary>
/// Checks of the option combinations <c>stus</c> accepts and refuses. The general parsing contract
...
public class CommandLineArgsOptionTests
{
    ...
    public void APinnedClockMakesARenderedFrameReproducible()
    {
        ...
        static string Render(string path, string clock)
        {
            ...
            var app = new Application(terminal, new Settings(), Theme.Classic(), input: null);
            app.Initialize(args);
            app.DrawFrame();
    ...
    {
        // "stus --size 80x25 --help" should print the usage text, not a parse error.
    ...
    private static string? FindRepositoryRoot([CallerFilePath] string sourceFile = "")
    {
        ...
        {
            if (File.Exists(Path.Combine(directory.FullName, "OpenStus.sln")) &&
