...
public class KeyBarLayoutTests
{
    ...
    {
        var bar = new KeyBar(Theme.Classic());
    ...
    {
        var bar = new KeyBar(Theme.Classic()) { Override = KeyBarLabels.Of("Aaa", "Bbb") };
...
public class KeyBarDrawTests
{
    ...
    public void ANullThemeIsRejectedUpFront()
    {
        ...
        Assert.Throws<ArgumentNullException>(static () => new KeyBar(Theme.Classic()).Draw(null!, 0));
    }
...
public class ClockWidgetTests
{
    ...
    public void AConsoleTooNarrowForTheTimeShowsNothingRatherThanARuinedRow()
    {
        ...
        new ClockWidget { TimeSource = () => new DateTime(2026, 8, 8, 10, 6, 0) }.Draw(buf, Theme.Classic());
