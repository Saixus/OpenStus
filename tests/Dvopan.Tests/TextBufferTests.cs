...
{
    private static readonly Dvopan.Theming.Theme Palette = Dvopan.Theming.Theme.Classic();

    private static Dvopan.Input.InputEvent Key(
        ConsoleKey key,
        Dvopan.Input.KeyMods mods = Dvopan.Input.KeyMods.None) =>
        Dvopan.Input.InputEvent.FromKey(new Dvopan.Input.KeyEvent(key, '\0', mods));

    private static Dvopan.Input.InputEvent Char(char c) =>
        Dvopan.Input.InputEvent.FromKey(
            new Dvopan.Input.KeyEvent(ConsoleKey.None, c, Dvopan.Input.KeyMods.None));
    ...
    public void CtrlYDeletesTheCurrentLine()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.Y, Dvopan.Input.KeyMods.Ctrl));
    ...
    public void CtrlZUndoesAndCtrlShiftZRedoes()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.Z, Dvopan.Input.KeyMods.Ctrl));
        Assert.Equal("x", editor.Buffer.GetText());

        editor.HandleInput(Key(ConsoleKey.Z, Dvopan.Input.KeyMods.Ctrl | Dvopan.Input.KeyMods.Shift));
    ...
    {
        var editor = Editor("abcd");
        editor.HandleInput(Key(ConsoleKey.RightArrow, Dvopan.Input.KeyMods.Shift));
        editor.HandleInput(Key(ConsoleKey.RightArrow, Dvopan.Input.KeyMods.Shift));
    ...
    public void CopyCutAndPasteGoThroughTheClipboardAbstraction()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.RightArrow, Dvopan.Input.KeyMods.Shift));
        editor.HandleInput(Key(ConsoleKey.RightArrow, Dvopan.Input.KeyMods.Shift));
        editor.HandleInput(Key(ConsoleKey.X, Dvopan.Input.KeyMods.Ctrl));

        Assert.Equal("ab", clipboard.GetText());
        Assert.Equal("cd", editor.Buffer.GetText());

        editor.HandleInput(Key(ConsoleKey.End));
        editor.HandleInput(Key(ConsoleKey.V, Dvopan.Input.KeyMods.Ctrl));
    ...
    public void CopyWithNoSelectionTakesTheWholeLine()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.C, Dvopan.Input.KeyMods.Ctrl));
    ...
    {
        var editor = Editor("a\nb\nc");
        editor.HandleInput(Key(ConsoleKey.DownArrow, Dvopan.Input.KeyMods.Shift));
        editor.HandleInput(Key(ConsoleKey.DownArrow, Dvopan.Input.KeyMods.Shift));

        editor.HandleInput(Key(ConsoleKey.Tab));
        Assert.Equal("\ta\n\tb\n\tc", editor.Buffer.GetText());

        editor.HandleInput(Key(ConsoleKey.Tab, Dvopan.Input.KeyMods.Shift));
        Assert.Equal("a\nb\nc", editor.Buffer.GetText());
    }
    ...
    public void WordMotionMovesByWords()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.RightArrow, Dvopan.Input.KeyMods.Ctrl));
        Assert.Equal(6, editor.Cursor.Column);

        editor.HandleInput(Key(ConsoleKey.LeftArrow, Dvopan.Input.KeyMods.Ctrl));
    ...
    public void CtrlHomeAndCtrlEndJumpToTheEndsOfTheDocument()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.End, Dvopan.Input.KeyMods.Ctrl));
        Assert.Equal((2, 3), (editor.Cursor.Line, editor.Cursor.Column));

        editor.HandleInput(Key(ConsoleKey.Home, Dvopan.Input.KeyMods.Ctrl));
    ...
    public void CtrlDownScrollsTheViewAndDragsTheCaretAlong()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.DownArrow, Dvopan.Input.KeyMods.Ctrl));
        ...
        editor.HandleInput(Key(ConsoleKey.UpArrow, Dvopan.Input.KeyMods.Ctrl));
    ...
    public void TheMouseWheelScrollsWithoutSnappingBackToTheCaret()
    {
        ...
        editor.HandleInput(Dvopan.Input.InputEvent.FromMouse(new Dvopan.Input.MouseEvent(
            Dvopan.Input.MouseKind.Wheel,
            0,
            0,
            Dvopan.Input.MouseButton.None,
            -1,
            Dvopan.Input.KeyMods.None)));
    ...
    public void ContinueSearchFindsAnOccurrenceFlushAgainstThePreviousMatch()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.F7, Dvopan.Input.KeyMods.Shift));
    ...
    public void ReplaceAllRunsAndReportsTheCount()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.F7, Dvopan.Input.KeyMods.Ctrl));
    ...
    public void GoToLineMovesTheCaret()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.F8, Dvopan.Input.KeyMods.Alt));
    ...
    {
        var ui = new FakeUi { MessageAnswer = Dvopan.Core.DialogResult.Cancel };
        ...
        ui.MessageAnswer = Dvopan.Core.DialogResult.No;
        Assert.False(editor.HandleInput(Key(ConsoleKey.Escape)));
        Assert.True(editor.IsClosed);
    }
    ...
    public void TheEditorKeyBarChangesWithTheHeldModifier()
    {
        ...
        Assert.Equal("Save", editor.KeyBarFor(Dvopan.Input.KeyMods.None)![1]);
        Assert.Equal("Quit", editor.KeyBarFor(Dvopan.Input.KeyMods.None)![9]);
        Assert.Equal("SaveAs", editor.KeyBarFor(Dvopan.Input.KeyMods.Shift)![1]);
        Assert.Equal("Replac", editor.KeyBarFor(Dvopan.Input.KeyMods.Ctrl)![6]);
        Assert.Equal("GoTo", editor.KeyBarFor(Dvopan.Input.KeyMods.Alt)![7]);
    }
    ...
    public void SelectedTextIsPaintedInTheSelectionColour()
    {
        ...
        var screen = new Dvopan.Rendering.ScreenBuffer(40, 6);
        editor.Layout(new Dvopan.Rendering.Rect(0, 0, 40, 6));
        editor.Draw(screen);
