...
public class PanelDrawTests
{
    ...
    public void TheScrollBarOnlyAppearsWhenTheListingOverflows()
    {
        ...
        Assert.Equal(Theme.Classic().PanelScrollBar, buffer.Get(39, 2).Style);
    }
    ...
    public void APanelTooSmallToDrawIsPaintedBlankInsteadOfThrowing()
    {
        ...
        Assert.Equal(Theme.Classic().PanelText, buffer.Get(0, 0).Style);
    }
...
{
    private static readonly Theme Palette = Theme.Classic();
...
public class PanelQuickSearchTests
{
    ...
    public void TheSearchBoxIsDrawnOnTheBottomFrame()
    {
        ...
        Assert.Equal(Theme.Classic().QuickSearch, buffer.Get(2, 19).Style);
    }
