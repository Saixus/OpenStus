...
public class ScreenshotTests
{
    ...
    public void TheColumnHeaderRowIsDrawnInTheColumnTitleColour()
    {
        ...
        Assert.Equal(Theme.FarDefault().PanelColumnTitle, cell.Style);
    }
    ...
    public void AViewModeFromTheCommandLineIsApplied()
    {
        ...
        var settings = new Settings { ShowClock = false };
        Terminal terminal = Terminal.Create(Width, Height);
        using var app = new Application(terminal, settings, Theme.FarDefault(), input: null);
...
public class CommandLineArgsTests
{
    ...
    public void HelpAndVersionAreRecognised()
    {
        ...
        Assert.Contains("Open Commander", CommandLineArgs.VersionText, StringComparison.Ordinal);
...
public class KeyBindingsTests
{
    ...
    public void DeleteOnlyDeletesWhileTheCommandLineIsEmpty()
    {
        ...
        using var app = new Application(terminal, new Settings { ShowClock = false }, Theme.FarDefault(), input: null);
