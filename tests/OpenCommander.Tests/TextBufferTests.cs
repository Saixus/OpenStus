...
{
    private static readonly OpenCommander.Theming.Theme Palette = OpenCommander.Theming.Theme.FarDefault();

    private static OpenCommander.Input.InputEvent Key(
        ConsoleKey key,
        OpenCommander.Input.KeyMods mods = OpenCommander.Input.KeyMods.None) =>
        OpenCommander.Input.InputEvent.FromKey(new OpenCommander.Input.KeyEvent(key, '\0', mods));

    private static OpenCommander.Input.InputEvent Char(char c) =>
        OpenCommander.Input.InputEvent.FromKey(
            new OpenCommander.Input.KeyEvent(ConsoleKey.None, c, OpenCommander.Input.KeyMods.None));
    ...
    public void CtrlYDeletesTheCurrentLine()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.Y, OpenCommander.Input.KeyMods.Ctrl));
    ...
    public void CtrlZUndoesAndCtrlShiftZRedoes()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.Z, OpenCommander.Input.KeyMods.Ctrl));
        Assert.Equal("x", editor.Buffer.GetText());

        editor.HandleInput(Key(ConsoleKey.Z, OpenCommander.Input.KeyMods.Ctrl | OpenCommander.Input.KeyMods.Shift));
    ...
    {
        var editor = Editor("abcd");
        editor.HandleInput(Key(ConsoleKey.RightArrow, OpenCommander.Input.KeyMods.Shift));
        editor.HandleInput(Key(ConsoleKey.RightArrow, OpenCommander.Input.KeyMods.Shift));
    ...
    public void CopyCutAndPasteGoThroughTheClipboardAbstraction()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.RightArrow, OpenCommander.Input.KeyMods.Shift));
        editor.HandleInput(Key(ConsoleKey.RightArrow, OpenCommander.Input.KeyMods.Shift));
        editor.HandleInput(Key(ConsoleKey.X, OpenCommander.Input.KeyMods.Ctrl));

        Assert.Equal("ab", clipboard.GetText());
        Assert.Equal("cd", editor.Buffer.GetText());

        editor.HandleInput(Key(ConsoleKey.End));
        editor.HandleInput(Key(ConsoleKey.V, OpenCommander.Input.KeyMods.Ctrl));
    ...
    public void CopyWithNoSelectionTakesTheWholeLine()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.C, OpenCommander.Input.KeyMods.Ctrl));
    ...
    {
        var editor = Editor("a\nb\nc");
        editor.HandleInput(Key(ConsoleKey.DownArrow, OpenCommander.Input.KeyMods.Shift));
        editor.HandleInput(Key(ConsoleKey.DownArrow, OpenCommander.Input.KeyMods.Shift));

        editor.HandleInput(Key(ConsoleKey.Tab));
        Assert.Equal("\ta\n\tb\n\tc", editor.Buffer.GetText());

        editor.HandleInput(Key(ConsoleKey.Tab, OpenCommander.Input.KeyMods.Shift));
        Assert.Equal("a\nb\nc", editor.Buffer.GetText());
    }
    ...
    public void WordMotionMovesByWords()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.RightArrow, OpenCommander.Input.KeyMods.Ctrl));
        Assert.Equal(6, editor.Cursor.Column);

        editor.HandleInput(Key(ConsoleKey.LeftArrow, OpenCommander.Input.KeyMods.Ctrl));
    ...
    public void CtrlHomeAndCtrlEndJumpToTheEndsOfTheDocument()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.End, OpenCommander.Input.KeyMods.Ctrl));
        Assert.Equal((2, 3), (editor.Cursor.Line, editor.Cursor.Column));

        editor.HandleInput(Key(ConsoleKey.Home, OpenCommander.Input.KeyMods.Ctrl));
    ...
    public void ReplaceAllRunsAndReportsTheCount()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.F7, OpenCommander.Input.KeyMods.Ctrl));
    ...
    public void GoToLineMovesTheCaret()
    {
        ...
        editor.HandleInput(Key(ConsoleKey.F8, OpenCommander.Input.KeyMods.Alt));
    ...
    {
        var ui = new FakeUi { MessageAnswer = OpenCommander.Core.DialogResult.Cancel };
        ...
        ui.MessageAnswer = OpenCommander.Core.DialogResult.No;
        Assert.False(editor.HandleInput(Key(ConsoleKey.Escape)));
        Assert.True(editor.IsClosed);
    }
    ...
    public void TheEditorKeyBarChangesWithTheHeldModifier()
    {
        ...
        Assert.Equal("Save", editor.KeyBarFor(OpenCommander.Input.KeyMods.None)![1]);
        Assert.Equal("Quit", editor.KeyBarFor(OpenCommander.Input.KeyMods.None)![9]);
        Assert.Equal("SaveAs", editor.KeyBarFor(OpenCommander.Input.KeyMods.Shift)![1]);
        Assert.Equal("Replac", editor.KeyBarFor(OpenCommander.Input.KeyMods.Ctrl)![6]);
        Assert.Equal("GoTo", editor.KeyBarFor(OpenCommander.Input.KeyMods.Alt)![7]);
    }
    ...
    public void SelectedTextIsPaintedInTheSelectionColour()
    {
        ...
        var screen = new OpenCommander.Rendering.ScreenBuffer(40, 6);
        editor.Layout(new OpenCommander.Rendering.Rect(0, 0, 40, 6));
        editor.Draw(screen);
