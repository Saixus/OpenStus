...
public sealed class Settings
{
    ...
    public const string AppFolderName = "Dvopan";
    ...
    /// <summary>
    /// Where <see cref="Load"/> and <see cref="Save"/> look: <c>%APPDATA%\Dvopan\settings.json</c>
    /// on Windows, <c>$XDG_CONFIG_HOME/Dvopan/settings.json</c> (defaulting to
