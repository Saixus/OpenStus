...
public sealed class Application : IAppContext, IDisposable
{
    ...
    public static Application Create(CommandLineArgs args)
    {
        ...
        // "stus C:\somewhere" means that folder, whatever was open last time.
    ...
    {
        if (_ui.Confirm("Exit", ["Do you want to quit Open Stus?"]))
        {
            RequestQuit();
        }
    }
    ...
    {
        string path = OpenStus.Core.Settings.SettingsFilePath;
