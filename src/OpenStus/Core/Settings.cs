...
public sealed class Settings
{
    ...
    public const string AppFolderName = "OpenStus";
    ...
    /// <summary>
    /// Where <see cref="Load"/> and <see cref="Save"/> look: <c>%APPDATA%\OpenStus\settings.json</c>
    /// on Windows, <c>$XDG_CONFIG_HOME/OpenStus/settings.json</c> (defaulting to
