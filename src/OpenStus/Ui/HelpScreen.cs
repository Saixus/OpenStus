...
public sealed class HelpScreen : IScreenComponent
{
    ...
    public string Title { get; set; } = "Open Stus Help";
    ...
    [
        ...
        ("Panels", "Enter", "Enter a folder or an archive, or run the file under the cursor"),
        ("Panels", "Ctrl+PgDn", "Enter the folder or archive under the cursor"),
        ...
        ("Panels", "Alt+F1 / Alt+F2", "Change the drive of the left / right panel; the other panel's folder when it is on that drive"),
        ...
        ("Commands", "Shift+F8", "Delete only the item under the cursor"),
        ...
        ("Editor", "F2", "Save"),
        ("Editor", "F5", "Switch syntax colouring off or on"),
        ("Editor", "F7", "Search"),
        ...
        ("Command line", "Shift+Left / Shift+Right", "Select text while the panels are hidden (Ctrl+O); Shift+Home / End and Ctrl+Shift+arrows too"),
        ("Command line", "Ctrl+C / Ctrl+Ins", "Copy the selected text; Shift+Del cuts it"),
